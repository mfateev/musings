...
This module demonstrates how to start a Temporal workflow execution.
It connects to the Temporal service and initiates the HelloWorldWorkflow.
"""
...
async def main():
    """
    Main function that starts the HelloWorldWorkflow.
    ...
    # Start workflow
    workflow_id = "hello-world-workflow-001"
    name_input = "Temporal"
